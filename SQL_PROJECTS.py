E-COMMERCE BUSINESS DATA ANALYSIS USING SQL  

GOALS:
    1) ANALYZE AND OPTIMIZE MARKETING CHANNELS
    2) MEASURE AND TEST WEBSITE CONVERSION PERFORMANCE
    3) USE DATA TO UNDERSTAND THE IMPACT OF NEW PRODUCT LAUNCHES
...
1)  Continue to work on different areas of the website where there is still a dropoff.
2)  Continuing to add additional products similar to some of the products that have been additive to the business.
